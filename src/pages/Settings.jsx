                ...
                <div className="flex-1 space-y-6">
                    {activeTab === 'Integrations' ? (
                        <>
                            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                                <div className="flex justify-between items-start mb-6">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">WhatsApp Cloud API</h3>
                                    {status?.is_connected ? (
                                        <span className="px-2 py-1 bg-green-100 text-green-700 text-xs font-bold rounded-full">Connected</span>
                                    ) : (
                                        <span className="px-2 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded-full">Disconnected</span>
                                    )}
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between mt-6">
                                        {status && (
                                            <Button variant="outline" className="text-red-500 hover:text-red-600" onClick={handleDisconnect}>
                                                Disconnect
                                            </Button>
                                        )}
                            ...
                            {status?.is_connected && (
                                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Webhook Callback URL</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Copy this URL to your Meta App Dashboard Webhook settings.</p>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-12 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Other settings tabs are currently under development.</p>
                        </div>
                    )}
                </div>
            </div>
